    ...
    "paths": { 
        ...
        "/recipe/NumPossiRP": { 
            "post": { 
                ...
                "description": "재료 목록을 input으로 주게 된다면 해당 목록을 기반으로 만들 수 있는 레시피의 개수를 반환해줍니다.", 
                "consumes": [ "application/json" ], 
                "produces": [ "application/json" ], 
                "parameters": [ { 
                    "in": "body", 
                    ...
                    "schema": {
                        ...
                        "properties": {
                            "ingre":{
                                "type": "array",
                                "example": ["당근", "소금", "양파", "후추", "쪽파", "설탕", "대파", "계란", "달걀", "마늘", "다진마늘", "간장", "밥", "배추김치", "김치", "고춧가루", "식용유", "두부", "물", "식초", "무", "꿀", "오징어", "밀가루", "콩나물"]
                            }
                        }
                     } } ], 
                "responses": { 
        ...
        "/recipe/ListPossiRP": { 
            "post": { 
                ...
                "description": "재료 목록을 input으로 주게 된다면 해당 목록을 기반으로 만들 수 있는 레시피의 목록를 반환해줍니다.", 
                "consumes": [ "application/json" ], 
                "produces": [ "application/json" ], 
                "parameters": [ { 
                    "in": "body", 
        ...
        "/recipe/ListPossiRPWithRecc": { 
            "post": { 
                ...
                "description": "재료 목록을 입력하면, 만들 수 있는 레시피의 목록을 파이썬의 추천 알고리즘을 거쳐서 추천순으로 나타냅니다.", 
                "consumes": [ "application/json" ], 
                "produces": [ "application/json" ], 
                "parameters": [ { 
                    "in": "body", 
