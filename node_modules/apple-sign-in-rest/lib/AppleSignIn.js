...
class AppleSignIn {
    constructor(options) {
        ...
        if (!(options === null || options === void 0 ? void 0 : options.keyIdentifier))
        ...
        if (Object.prototype.hasOwnProperty.call(options, "privateKey")) {
            ...
            if (!(options === null || options === void 0 ? void 0 : options.privateKeyPath)) {
                throw new Error("privateKeyPath is empty");
            }
            if (!fs_1.default.existsSync(options.privateKeyPath)) {
                throw new Error("Private key file for given path doesn't exist");
            }
            privateKey = fs_1.default.readFileSync(options.privateKeyPath, "utf-8");
        }
        if (!privateKey) {
         ...
         */
        this.jwksClient = jwks_rsa_1.default({
    ...
    getAuthorizationUrl(options) {
        ...
        const url = new url_1.URL("https://appleid.apple.com/auth/authorize");
    ...
    code, options) {
        ...
        let results;
        try {
            const response = await axios_1.default("https://appleid.apple.com/auth/token", {
                method: "post",
                data: querystring_1.default.stringify({
                    ...
                    code,
                    redirect_uri: options === null || options === void 0 ? void 0 : options.redirectUri,
                }),
            });
            results = response.data;
        }
        catch (err) {
            const statusCode = (_a = err === null || err === void 0 ? void 0 : err.response) === null || _a === void 0 ? void 0 : _a.status;
            const reason = (_c = (_b = err === null || err === void 0 ? void 0 : err.response) === null || _b === void 0 ? void 0 : _b.data) === null || _c === void 0 ? void 0 : _c.error;
            if (reason) {
    ...
    createClientSecret(options) {
        ...
        const claimDurationSeconds = (options === null || options === void 0 ? void 0 : options.expirationDuration) || MAX_CLAIM_DURATION_SECONDS;
        ...
        return jsonwebtoken_1.default.sign(claims, this.privateKey, { algorithm: "ES256", header });
    }
    ...
    async verifyIdToken(idToken, options) {
        ...
        const kid = (_a = decodedIdToken === null || decodedIdToken === void 0 ? void 0 : decodedIdToken.header) === null || _a === void 0 ? void 0 : _a.kid;
        const alg = (_b = decodedIdToken === null || decodedIdToken === void 0 ? void 0 : decodedIdToken.header) === null || _b === void 0 ? void 0 : _b.alg;
        if (!kid)
        ...
        const jwtClaims = jsonwebtoken_1.default.verify(idToken, key.getPublicKey(), {
            issuer: "https://appleid.apple.com",
            audience: this.clientId,
            algorithms: [alg],
            nonce: options === null || options === void 0 ? void 0 : options.nonce,
            ignoreExpiration: options === null || options === void 0 ? void 0 : options.ignoreExpiration,
